...
@named sollWinkel = Trapezoid(offset=0.0, amplitude=pi/8, rising=0.1, width=0.8, falling=0.1, period=10.0, nperiod=-1.0, startTime=0.0)
@named wunschMoment = Konst()
